...
const toJsonSchema = (schema) => zodToJsonSchema(schema, { $refStrategy: 'root' });
/**
 ...
 */
export const CodeQualityResultJSONSchema = toJsonSchema(CodeQualityResultSchema);
export const TestCoverageResultJSONSchema = toJsonSchema(TestCoverageResultSchema);
export const RefactoringSuggestionJSONSchema = toJsonSchema(RefactoringSuggestionSchema);
//# sourceMappingURL=analysis-results.js.map