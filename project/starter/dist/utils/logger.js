 ...
 */
export const logReviewStart = (owner, repo, prNumber) => {
    logger.info('Starting code review', { owner, repo, prNumber });
};
export const logReviewComplete = (owner, repo, prNumber, score, duration) => {
...
export const logReviewError = (owner, repo, prNumber, error) => {
...
export const logAgentStart = (agentName, file) => {
    logger.debug('Subagent starting', { agent: agentName, file });
};
export const logAgentComplete = (agentName, file, duration) => {
